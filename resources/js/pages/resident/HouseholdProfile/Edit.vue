      ...
      <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white p-8 rounded-2xl shadow-2xl">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h1 class="text-3xl font-bold mb-2">Edit Household Profile</h1>
              <p class="text-blue-100 text-lg">Update your family information and income details</p>
            </div>
          </div>
      ...
      <form @submit.prevent="submitForm" class="space-y-8">
          ...
          <div v-else class="space-y-6">
            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- Basic Information -->
                <div>
                  <Label :for="`member_${index}_first_name`">First Name *</Label>
                  <Input
                  ...
                  />
                  <p v-if="form.errors[`family_members.${index}.first_name`]" class="text-red-500 text-sm mt-1">
                    {{ form.errors[`family_members.${index}.first_name`] }}
                  </p>
                </div>

                <div>
                  <Label :for="`member_${index}_middle_name`">Middle Name</Label>
                  <Input
                ...
                <div>
                  <Label :for="`member_${index}_last_name`">Last Name *</Label>
                  <Input
                  ...
                  />
                  <p v-if="form.errors[`family_members.${index}.last_name`]" class="text-red-500 text-sm mt-1">
                    {{ form.errors[`family_members.${index}.last_name`] }}
                  </p>
                </div>

                <div>
                  <Label :for="`member_${index}_relationship`">Relationship to Head *</Label>
                  ...
                  <p v-if="form.errors[`family_members.${index}.relationship_to_head`]" class="text-red-500 text-sm mt-1">
                    {{ form.errors[`family_members.${index}.relationship_to_head`] }}
                  </p>
                </div>

                <div>
                  <Label :for="`member_${index}_birth_date`">Birth Date</Label>
                  <Input
                ...
                <div>
                  <Label :for="`member_${index}_sex`">Sex</Label>
                ...
                <div>
                  <Label :for="`member_${index}_civil_status`">Civil Status</Label>
                ...
                <div>
                  <Label :for="`member_${index}_educational_attainment`">Educational Attainment</Label>
                ...
                <div>
                  <Label :for="`member_${index}_occupation`">Occupation</Label>
                  <Input
                ...
                <div>
                  <Label :for="`member_${index}_employment_status`">Employment Status</Label>
                ...
                <div>
                  <Label :for="`member_${index}_monthly_income`">Monthly Income (₱)</Label>
                  <Input
                ...
                <div class="md:col-span-2 lg:col-span-3">
                  ...
                  <div v-if="member.is_pwd" class="mt-4">
                    <Label :for="`member_${index}_disability_details`">Disability Details</Label>
                    <Textarea
                ...
                <div class="md:col-span-2 lg:col-span-3">
                  <Label :for="`member_${index}_additional_notes`">Additional Notes</Label>
                  <Textarea
        ...
        <div class="flex justify-end gap-3 pt-6 border-t">
          ...
          >
            ...
            {{ form.processing ? 'Updating...' : 'Update Household Profile' }}
          </Button>
        </div>
      </form>
    </div>
...
const breadcrumbs = createBreadcrumbs([
  ...
  { title: 'Edit', href: `/resident/household-profile/${props.householdProfile.id}/edit` },
]);

const form = useForm({
  household_head_name: props.householdProfile.household_head_name || '',
  household_head_relationship: props.householdProfile.household_head_relationship || 'self',
  monthly_income: props.householdProfile.monthly_income || null,
  income_source: props.householdProfile.income_source || '',
  income_source_details: props.householdProfile.income_source_details || '',
  total_family_members: props.householdProfile.total_family_members || 1,
  working_members: props.householdProfile.working_members || 0,
  dependent_members: props.householdProfile.dependent_members || 0,
  housing_type: props.householdProfile.housing_type || '',
  housing_details: props.householdProfile.housing_details || '',
  has_vehicle: props.householdProfile.has_vehicle || false,
  vehicle_details: props.householdProfile.vehicle_details || '',
  has_livestock: props.householdProfile.has_livestock || false,
  livestock_details: props.householdProfile.livestock_details || '',
  additional_notes: props.householdProfile.additional_notes || '',
  family_members: props.householdProfile.family_members || [],
});
...
const submitForm = () => {
  form.put(`/resident/household-profile/${props.householdProfile.id}`, {
    onSuccess: () => {
      toast.success('Household profile updated successfully!');
    },
    onError: () => {
      toast.error('Failed to update household profile. Please check the form and try again.');
    },
  });
};
