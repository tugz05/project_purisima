    ...
    >
        ...
        >
            ...
            <div class="grid gap-3">
                <Button as-child variant="outline" class="h-11 w-full border-gray-300 hover:bg-gray-50" tabindex="0">
            ...
            <div class="relative my-2">
                ...
                <div class="relative flex justify-center text-xs uppercase">
                    <span class="bg-white px-3 text-xs font-medium text-gray-500">Or continue with email</span>
                </div>
            </div>
            ...
            <div class="grid gap-5">
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        type="checkbox"
                        name="terms_accepted_checkbox"
                        :tabindex="8"
                        class="h-4 w-4 cursor-pointer rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <Label for="terms_accepted" class="cursor-pointer text-xs text-gray-600">
                        I agree to the
                        <a href="#" class="text-blue-600 underline hover:text-blue-700" target="_blank" @click.prevent>Terms</a>
                        and
                        <a href="#" class="text-blue-600 underline hover:text-blue-700" target="_blank" @click.prevent>Data Privacy Act</a>
                    </Label>
                </div>
                ...
                <Button
                    type="submit"
                    class="mt-2 h-11 w-full bg-gradient-to-r from-blue-600 to-cyan-500 font-semibold text-white shadow-lg transition-all duration-200 hover:from-blue-700 hover:to-cyan-600 disabled:cursor-not-allowed disabled:opacity-50"
                    tabindex="9"
            ...
            <div class="pt-2 text-center text-sm text-gray-600">
                ...
                <TextLink :href="login()" class="font-medium text-blue-600 hover:text-blue-700" :tabindex="10">Log in</TextLink>
            </div>
        </Form>
    </AuthBase>
</template>
