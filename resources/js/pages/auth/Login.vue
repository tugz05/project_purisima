...
<template>
    <AuthBase 
        title="Welcome Back" 
        description="Log in to access Uni Respond services and manage your transactions"
    >
        <Head title="Log in" />
        ...
        >
            <div class="grid gap-3">
                <Button as-child variant="outline" class="w-full border-gray-300 hover:bg-gray-50" :tabindex="0">
                    <a :href="oauthRedirect({ provider: 'google' }).url" class="flex items-center justify-center gap-2">
                ...
                <Button as-child variant="outline" class="w-full border-gray-300 hover:bg-gray-50" :tabindex="0">
                    <a :href="oauthRedirect({ provider: 'facebook' }).url" class="flex items-center justify-center gap-2">
            ...
            <div class="grid gap-6">
                ...
                <Button type="submit" class="mt-4 w-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white shadow-lg" :tabindex="4" :disabled="form.processing">
