...
<template>
    ...
    >
        ...
        <Form :form="form" class="flex flex-col gap-6" @submit="submit">
            <div class="grid gap-6">
                ...
                <Button
                    type="submit"
                    class="mt-4 w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-lg hover:from-blue-700 hover:to-cyan-600"
                    :tabindex="4"
