          ...
          <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4">
                ...
                <div>
                  <h1 class="text-3xl font-bold text-white mb-2">Create Announcement</h1>
                  <p class="text-blue-100 text-lg">Share important information with the community</p>
                </div>
              </div>

              <div class="flex items-center gap-4">
                <!-- Auto-save indicator -->
                <div v-if="autoSaveStatus === 'saved'" class="flex items-center gap-2 text-white/90 bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
              ...
              <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                  <div class="border-2 border-gray-200 rounded-xl overflow-hidden focus-within:border-purple-500 focus-within:ring-4 focus-within:ring-purple-500/20 transition-all duration-300"
                    ...
                    <VueQuillEditor v-model="form.content" @update:modelValue="triggerAutoSave" />
                  </div>
...
const autoSaveStatus = ref<'idle' | 'saved'>('idle');
...
const form = useForm({
  ...
  priority: 'normal', // Set default value
  author_name: '',
